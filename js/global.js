const menu = [
    {
        ...
        "likes": 3,
        "iscomment": ["Nice recipe!", "Looks delicious"],
        "steps": [
    ...
    },
    {
        ...
        "likes": 6,
        "iscomment": ["Looks delicious", "Nice recipe!", "Yummy"],
        "steps": [
    ...
    },
    {
        ...
        "likes": 2,
        "iscomment": ["Nice recipe!", "look tasty"],
        "imageURL": "../Image/Curried-Lentils and-Rice.jpg",
    },
    {
        ...
        "likes": 5,
        "iscomment": ["look tasty", "Really good!", "Nice recipe!"],
        "steps": [
    ...
    },
    {
        ...
        "likes": 7,
        "iscomment": ["Tastes great!", "Really good!", "Nice recipe!", "Looks delicious", "Yummy"],
        "steps": [
    ...
    },
    {
        ...
        "likes": 9,
        "iscomment": ["Looks delicious", "Nice recipe!"],
        "steps": [
    ...
    },
    {
        ...
        "likes": 10,
        "iscomment": ["look tasty", "Yummy", "Looks delicious"],
        "steps": [
        ...
        "imageURL": "http://contenthandler.azureedge.net/recp/606/2000/0/584.jpg",
    ...
    },
    {
        ...
        "likes": 3,
        "iscomment": ["Yummy", "Looks delicious", "Osm"],
        "steps": [
...
const moonIcon = IconContainer.children[1];
...
if (profile) {
    // seclect div and icon container for mobile Menu
    const Mobile_Header = document.querySelector(".Mobile_Header");
    const mobile_list = document.querySelector(".mobile_list");
    Mobile_Header.addEventListener('click', (e) => {
        let openMenu = e.currentTarget.children[0];
        let closeMenu = e.currentTarget.children[1];
        if (!openMenu.classList.contains('active')) {
            mobile_list.classList.remove("disable");
            openMenu.classList.add('active')
            closeMenu.classList.remove('active')
        } else {
            mobile_list.classList.add("disable");
            openMenu.classList.remove('active')
            closeMenu.classList.add('active')
        }
    })
    // seclect profile to Open Profile
    const profile = document.querySelector(".profile");
